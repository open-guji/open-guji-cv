...
| 页面 | URL | 快照/真源 | 再生 |
|---|---|---|---|
| **种子审查页**（逐页进库人裁）| https://claude.ai/code/artifact/98d441fc-b27e-482a-a0c0-1cf1f72d170d | [vol01_seed_review.html](vol01_seed_review.html) | `scripts/export_seed_review.py output/vol01 --page 26,27,31,…,40`（逗号分隔可多页一批）。当前 26~40 页 64 条待审；**发布一律覆盖同一 URL**（用户 2026-08-26 定，不必再问）|
