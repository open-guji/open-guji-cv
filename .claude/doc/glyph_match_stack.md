...
**现行基线**（elastic 判据 + 不做笔宽归一，2026-08-24）：
...
| char-clustering 碎片率 | **2.79 / 3.01 / 2.58** | 上一版 2.97/3.38/3.04——三片全面改善 |
| char-clustering 难例对 | **39/80、35/74、26/65** | 上一版 40/34/14，净 +12（人工层同字对 9/60 → 21/60）|
| char-normalization | **33/33 过门** | golden 已重冻（人工目视门，见 §六.3）|
| glyph-match/pairs 主指标 | **recall 0.1067 @ 闸 0.996**，precision 0.99909 | elastic+笔宽归一 0.0807；coverage 判据 0.0140 |
| eval_db_match 覆盖 / 精度 | **8.5% / 16.3% / 17.9%，三协议精度全 1.0000** | elastic+笔宽归一 6.2/11.4/13.5；coverage 判据 10.4/16.6/21.8（字形精度 .9968/.9985）|
