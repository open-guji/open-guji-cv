...
from .routers import (border_review, column_review, cutline, evals, feedback, glyph_match,
                      gold, jiazhu, products, rare, registry, review, runs, spa_fallback,
                      step9, variants, workspace)
...
ROUTERS = (registry, workspace, runs, products, feedback, gold, evals,
           review, cutline, border_review, column_review, jiazhu, rare, glyph_match,
           variants, step9, spa_fallback)
